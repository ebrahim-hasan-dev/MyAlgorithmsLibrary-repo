...
namespace MyAlgorithmsLib
{
	...
	{
		vector <Internal::LetterAndHisCode> vec = Internal::_CreateHuffmanCodeHelper1(str);
	...
	{
		if (Internal::_Root == nullptr && Internal::_vLettersAndHisCode.size() == 0)
		{
			cout << "\n\nnot happend any create huffman code!\n\n";
			return "";
		}

		Internal::stNode* root = Internal::_DeCompressionHelper();

		Internal::stNode* tmp = root;
